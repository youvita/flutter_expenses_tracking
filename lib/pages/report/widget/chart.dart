...
class ChartReport extends StatefulWidget {
  ...
  const ChartReport({super.key, required this.income, required this.expenses});
...
class _ChartReportState extends State<ChartReport> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      _LabelChart(income: widget.income, expenses: widget.expenses,)
    ],);
  }
...
class _LabelChart extends StatelessWidget {
  final double income;
  final double expenses;
  const _LabelChart({super.key, required this.income, required this.expenses});
